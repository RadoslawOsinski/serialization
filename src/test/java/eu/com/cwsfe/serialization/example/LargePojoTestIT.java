...
public class LargePojoTestIT {
    ...
    public PojoData testPojoWithJson(RestState restState) {
        ...
        ResponseEntity<PojoData> response = restState.restTemplate.exchange("http://localhost:8080/largePojo", HttpMethod.GET, entity, PojoData.class);
    ...
    public PojoData testPojoWithKryo(RestState restState) {
        ...
        ResponseEntity<PojoData> response = restState.kryoRestTemplate.exchange("http://localhost:8080/largePojo", HttpMethod.GET, entity, PojoData.class);
        PojoData resource = response.getBody();
